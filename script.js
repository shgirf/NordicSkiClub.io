...
// ============================================
// Privacy Notice Controller (Homepage only)
// ============================================
class PrivacyController {
    ...
    showFullPrivacyStatement() {
        ...
        content.innerHTML = `
            ...
            <p style="margin-bottom: 1rem;">We collect this data to improve your browsing experience by remembering your preferences.</p>
            ...
            <p style="margin-bottom: 1rem;">This site may display embedded content (videos, forms from Google). These embeds are governed by the privacy policies of their respective providers.</p>
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // Initialize privacy controls (only if privacy notice exists - homepage only)
